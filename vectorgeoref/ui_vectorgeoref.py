...
#
# Created: Tue Dec 03 23:50:01 2013
...
class Ui_VectorGeoref(object):
    def setupUi(self, VectorGeoref):
        ...
        self.gridLayout.addWidget(self.pushButton_load_layer, 0, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.pushButtonCP_Selection, 1, 1, 1, 1)
        spacerItem = QtGui.QSpacerItem(75, 116, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        self.gridLayout.addItem(spacerItem, 2, 1, 1, 1)
        self.actionPan = QtGui.QToolButton(VectorGeoref)
        self.actionPan.setMinimumSize(QtCore.QSize(78, 0))
        self.actionPan.setCheckable(True)
        self.actionPan.setObjectName(_fromUtf8("actionPan"))
        self.gridLayout.addWidget(self.actionPan, 3, 1, 1, 1)
        spacerItem1 = QtGui.QSpacerItem(75, 116, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        ...
        self.gridLayout.addWidget(self.pushButton_run, 6, 1, 1, 1)
        self.pushButton_cancel = QtGui.QPushButton(VectorGeoref)
        self.pushButton_cancel.setObjectName(_fromUtf8("pushButton_cancel"))
        self.gridLayout.addWidget(self.pushButton_cancel, 7, 1, 1, 1)
    ...
    def retranslateUi(self, VectorGeoref):
        ...
        self.actionPan.setText(QtGui.QApplication.translate("VectorGeoref", "Pan", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.pushButton_cancel.setText(QtGui.QApplication.translate("VectorGeoref", "Cancel", None, QtGui.QApplication.UnicodeUTF8))
        self.tableWidget.horizontalHeaderItem(0).setText(QtGui.QApplication.translate("VectorGeoref", "selected", None, QtGui.QApplication.UnicodeUTF8))
        self.tableWidget.horizontalHeaderItem(1).setText(QtGui.QApplication.translate("VectorGeoref", "x  origine", None, QtGui.QApplication.UnicodeUTF8))
        self.tableWidget.horizontalHeaderItem(2).setText(QtGui.QApplication.translate("VectorGeoref", "y  origine", None, QtGui.QApplication.UnicodeUTF8))
        self.tableWidget.horizontalHeaderItem(3).setText(QtGui.QApplication.translate("VectorGeoref", "x destinazione", None, QtGui.QApplication.UnicodeUTF8))
        self.tableWidget.horizontalHeaderItem(4).setText(QtGui.QApplication.translate("VectorGeoref", "y destinazione", None, QtGui.QApplication.UnicodeUTF8))
